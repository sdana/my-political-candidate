...
function addMissionStatement(){
    ...
    missionStatementHeader.setAttribute("class", "missionStatementHeader");
    missionStatementTextP.setAttribute("class", "mission-statement-text");
    ...
    missionStatementSection.appendChild(missionStatementTextP).appendChild(missionStatementText);
